...
## 2026-09-12 본섭 1인당 총생산 성분별 복원

총생산 정본과 주간 보스 분해를 결합한 [조건부 복원 보고서](docs/MAIN_TOTAL_COMPONENTS_2026-09-12.md)와 `data/main_total_components_20260912/`를 추가했습니다. 주간 보스 밖의 잔액에 월간 보스가 포함되므로 별도 배분 시나리오로 계산했으며 단일 중심선은 선정하지 않았습니다.
